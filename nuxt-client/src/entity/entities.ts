...
export class Entities {
  ...
  public update(
    ...
    this._object.physicsImpostor.setAngularVelocity(
      new Vector3(angularVelocity._x, angularVelocity._y, angularVelocity._z)
    );
    this._object.physicsImpostor.setLinearVelocity(
      new Vector3(linearVelocity._x, linearVelocity._y, linearVelocity._z)
    );
...
export function createEntity(
  ...
  let entityImposter: PhysicsImpostor = new PhysicsImpostor(
    mesh,
    imposterType,
