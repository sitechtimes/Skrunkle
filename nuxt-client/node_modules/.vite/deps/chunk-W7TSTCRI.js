...
var Bone = class extends Node {
  constructor(name44, skeleton, parentBone = null, localMatrix = null, restPose = null, baseMatrix = null, index = null) {
          ...
          const tryToPlay = () => {
            ...
            if ((_a2 = Engine.audioEngine) === null || _a2 === void 0 ? void 0 : _a2.audioContext) {
              ...
              if (this._soundSource && this._inputAudioNode) {
                ...
                const actualOffset = ((this.isPaused ? this._startOffset : 0) + ((_d2 = this._offset) !== null && _d2 !== void 0 ? _d2 : 0)) % this._soundSource.buffer.duration;
...
var Skeleton = class {
  ...
  clone(name44, id) {
    const result = new Skeleton(name44, id || name44, this._scene);
...
var TargetCamera = class extends Camera {
  ...
  createRigCamera(name44, cameraIndex) {
    if (this.cameraRigMode !== Camera.RIG_MODE_NONE) {
      const rigCamera = new TargetCamera(name44, this.position.clone(), this.getScene());
...
var shader4 = `uniform vec4 vEyePosition;
...
var shader10 = `vec3 hemisphereCosSample(vec2 u) {
float phi=2.*PI*u.x;
...
var shader11 = `#define RECIPROCAL_PI2 0.15915494
...
var shader32 = `float NdotVUnclamped=dot(normalW,viewDirectionW);
...
var shader33 = `float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);
...
var shader36 = `#if defined(ENVIRONMENTBRDF)
#ifdef MS_BRDF_ENERGY_CONSERVATION
...
var shader37 = `vec3 finalDiffuse=diffuseBase;
...
var shader42 = `uniform mat4 view;
...
var PBRMaterial = class extends PBRBaseMaterial {
  ...
  clone(name44) {
    const clone = SerializationHelper.Clone(() => new PBRMaterial(name44, this.getScene()), this);
    clone.id = name44;
    clone.name = name44;
...
var MorphTarget = class {
  ...
  static FromMesh(mesh, name44, influence) {
    ...
    const result = new MorphTarget(name44, influence, mesh.getScene());
...
//# sourceMappingURL=chunk-W7TSTCRI.js.map
