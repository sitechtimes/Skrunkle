...
var ColorPicker = class extends Control {
  ...
  set value(value) {
    ...
    if (this._value.r >= 1 - ColorPicker._Epsilon) {
      this._value.r = 1;
    }
    if (this._value.g >= 1 - ColorPicker._Epsilon) {
      this._value.g = 1;
    }
    if (this._value.b >= 1 - ColorPicker._Epsilon) {
      this._value.b = 1;
    }
...
var VirtualKeyboard = class extends StackPanel {
  constructor() {
    super(...arguments);
  ...
  static CreateDefaultLayout(name22) {
    const returnValue = new VirtualKeyboard(name22);
...
var AdvancedDynamicTexture = class extends DynamicTexture {
  ...
  static CreateFullscreenUI(name22, foreground = true, scene = null, sampling = Texture.BILINEAR_SAMPLINGMODE, adaptiveScaling = false) {
    const result = new AdvancedDynamicTexture(name22, 0, 0, scene, false, sampling);
...
var FluentMaterial = class extends PushMaterial {
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new FluentMaterial(name22, this.getScene()), this);
  }
  serialize() {
...
var TouchHolographicMenu = class extends VolumeBasedPanel {
  constructor(name22) {
    super(name22);
...
var shader3 = `uniform vec3 cameraPosition;
...
var shader4 = `uniform mat4 world;
uniform mat4 viewProjection;
...
var FluentBackplateMaterial = class extends PushMaterial {
  constructor(name22, scene) {
    super(name22, scene);
    this.radius = 0.03;
    this.lineWidth = 0.01;
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new FluentBackplateMaterial(name22, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var HolographicBackplate = class extends Control3D {
  ...
  _createNode(scene) {
    ...
    SceneLoader.ImportMeshAsync(void 0, HolographicBackplate.MODEL_BASE_URL, HolographicBackplate.MODEL_FILENAME, scene).then((result) => {
...
var shader5 = `uniform vec3 cameraPosition;
varying vec3 vPosition;
varying vec3 vNormal;
varying vec2 vUV;
varying vec3 vTangent;
...
var shader6 = `uniform mat4 world;
uniform mat4 viewProjection;
uniform vec3 cameraPosition;
attribute vec3 position;
attribute vec3 normal;
...
var FluentButtonMaterial = class extends PushMaterial {
  constructor(name22, scene) {
    super(name22, scene);
    this.edgeWidth = 0.04;
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new FluentButtonMaterial(name22, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var TouchHolographicButton = class extends TouchButton3D {
  constructor(name22, shareMaterials = true) {
    super(name22);
    this._shareMaterials = true;
  ...
  _createNode(scene) {
    ...
    SceneLoader.ImportMeshAsync(void 0, TouchHolographicButton.MODEL_BASE_URL, TouchHolographicButton.MODEL_FILENAME, scene).then((result) => {
...
var shader7 = `precision highp float;
attribute vec3 position;
...
var shader8 = `uniform vec3 color;
void main(void) {
...
var HolographicSlate = class extends ContentDisplay3D {
  constructor(name22) {
    super(name22);
...
var NearMenu = class extends TouchHolographicMenu {
  constructor(name22) {
    super(name22);
...
var shader9 = `uniform vec3 cameraPosition;
varying vec3 vPosition;
varying vec3 vNormal;
varying vec2 vUV;
varying vec3 vTangent;
...
var shader10 = `uniform mat4 world;
uniform mat4 viewProjection;
uniform vec3 cameraPosition;
attribute vec3 position;
attribute vec3 normal;
...
var MRDLSliderBarMaterial = class extends PushMaterial {
  constructor(name22, scene) {
    super(name22, scene);
    this.radius = 0.6;
    this.bevelFront = 0.6;
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new MRDLSliderBarMaterial(name22, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var shader11 = `uniform vec3 cameraPosition;
varying vec3 vPosition;
varying vec3 vNormal;
varying vec2 vUV;
varying vec3 vTangent;
...
var shader12 = `uniform mat4 world;
uniform mat4 viewProjection;
uniform vec3 cameraPosition;
attribute vec3 position;
attribute vec3 normal;
...
var MRDLSliderThumbMaterial = class extends PushMaterial {
  constructor(name22, scene) {
    super(name22, scene);
    this.radius = 0.157;
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new MRDLSliderThumbMaterial(name22, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var shader13 = `uniform vec3 cameraPosition;
varying vec3 vPosition;
varying vec3 vNormal;
varying vec2 vUV;
varying vec3 vTangent;
...
var shader14 = `uniform mat4 world;
uniform mat4 viewProjection;
uniform vec3 cameraPosition;
attribute vec3 position;
attribute vec3 normal;
...
var MRDLBackplateMaterial = class extends PushMaterial {
  constructor(name22, scene) {
    super(name22, scene);
    this.radius = 0.3;
    this.lineWidth = 3e-3;
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new MRDLBackplateMaterial(name22, this.getScene()), this);
  }
  serialize() {
    const serializationObject = super.serialize();
...
var Slider3D = class extends Control3D {
  ...
  _createNode(scene) {
    ...
    SceneLoader.ImportMeshAsync(void 0, Slider3D.MODEL_BASE_URL, Slider3D.MODEL_FILENAME, scene).then((result) => {
...
var shader15 = `uniform vec3 cameraPosition;
varying vec3 vNormal;
varying vec2 vUV;
...
var shader16 = `uniform mat4 world;
uniform mat4 viewProjection;
uniform vec3 cameraPosition;
attribute vec3 position;
attribute vec3 normal;
...
var MRDLBackglowMaterial = class extends PushMaterial {
  constructor(name22, scene) {
    super(name22, scene);
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new MRDLBackglowMaterial(name22, this.getScene()), this);
  }
  serialize() {
...
var shader17 = `uniform vec3 cameraPosition;
varying vec3 vNormal;
varying vec2 vUV;
varying vec3 vTangent;
varying vec4 vExtra1;
...
var shader18 = `uniform mat4 world;
uniform mat4 viewProjection;
uniform vec3 cameraPosition;
attribute vec3 position;
attribute vec3 normal;
...
var MRDLFrontplateMaterial = class extends PushMaterial {
  constructor(name22, scene) {
    super(name22, scene);
    this.radius = 0.12;
    this.lineWidth = 0.01;
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new MRDLFrontplateMaterial(name22, this.getScene()), this);
  }
  serialize() {
    const serializationObject = SerializationHelper.Serialize(this);
...
var shader19 = `uniform vec3 cameraPosition;
varying vec2 vUV;
varying vec3 vTangent;
uniform vec4 _Color_;
uniform float _Radius_;
...
var shader20 = `uniform mat4 world;
uniform mat4 viewProjection;
uniform vec3 cameraPosition;
attribute vec3 position;
attribute vec3 normal;
...
var MRDLInnerquadMaterial = class extends PushMaterial {
  constructor(name22, scene) {
    super(name22, scene);
  ...
  clone(name22) {
    return SerializationHelper.Clone(() => new MRDLInnerquadMaterial(name22, this.getScene()), this);
  }
  serialize() {
    const serializationObject = SerializationHelper.Serialize(this);
...
var TouchHolographicButton2 = class extends TouchButton3D {
  constructor(name22, shareMaterials = true) {
    super(name22);
    this.width = 1;
    this.height = 1;
  ...
  _createBackPlate(scene) {
    ...
    SceneLoader.ImportMeshAsync(void 0, TouchHolographicButton2.MRTK_ASSET_BASE_URL, TouchHolographicButton2.BACKPLATE_MODEL_FILENAME, scene).then((result) => {
  ...
  _createFrontPlate(scene) {
    ...
    SceneLoader.ImportMeshAsync(void 0, TouchHolographicButton2.MRTK_ASSET_BASE_URL, TouchHolographicButton2.FRONTPLATE_MODEL_FILENAME, scene).then((result) => {
  ...
  _createInnerQuad(scene) {
    ...
    SceneLoader.ImportMeshAsync(void 0, TouchHolographicButton2.MRTK_ASSET_BASE_URL, TouchHolographicButton2.INNERQUAD_MODEL_FILENAME, scene).then((result) => {
  ...
  _createBackGlow(scene) {
    ...
    SceneLoader.ImportMeshAsync(void 0, TouchHolographicButton2.MRTK_ASSET_BASE_URL, TouchHolographicButton2.BACKGLOW_MODEL_FILENAME, scene).then((result) => {
