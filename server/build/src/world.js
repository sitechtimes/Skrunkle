...
var World = /** @class */ (function () {
  function World() {
    ...
    this.worldSize = {
      top: new babylonjs_1.Vector3(5000, 10000, 5000),
      bottom: new babylonjs_1.Vector3(-5000, 0, -5000),
    };
    this.isday = true;
    this.alpha_time = 0;
  ...
  World.prototype.validateEntityPosition = function (entityPosition) {
    if (
      entityPosition.x < this.worldSize.bottom.x ||
      entityPosition.x > this.worldSize.top.x ||
      entityPosition.y < this.worldSize.bottom.y ||
      entityPosition.y > this.worldSize.top.y ||
      entityPosition.z < this.worldSize.bottom.z ||
      entityPosition.z > this.worldSize.top.z
    ) {
      console.log(
        "EXCEEDED LIMITS: " +
          entityPosition +
          " compared to " +
          this.worldSize.bottom +
          " and " +
          this.worldSize.top
      );
  ...
  World.prototype.init = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_o) {
        switch (_o.label) {
          case 0:
            camera = new babylonjs_1.ArcRotateCamera(
              "Camera",
              0,
              0.8,
              100,
              babylonjs_1.Vector3.Zero(),
              this._scene
            );
            this._scene.enablePhysics(
              new babylonjs_1.Vector3(0, -9.81, 0),
              new babylonjs_1.OimoJSPlugin(true, 10, OIMO)
            );
            this._scene.executeWhenReady(function () {
              _this.logger.progress(
                "Scene is ready, running server side simulation"
              );
            ...
            this.logger.interval_logger(this._tick_time, function () {
              _this.logger.progress(
                "Avg Server tick ("
                  .concat(_this._tick_time, " ms): ")
                  .concat(_this._get_tick)
              );
            });
            state_machine_1.state_machine.setWorld(this);
            this._ground = babylonjs_1.MeshBuilder.CreateGround(
              "ground",
              { width: 10000, height: 10000 },
              this._scene
            );
            this._ground.position = new babylonjs_1.Vector3(0, 0, 0);
            this._ground.physicsImpostor = new babylonjs_1.PhysicsImpostor(
              this._ground,
              babylonjs_1.PhysicsImpostor.BoxImpostor,
            ...
            return [
              4 /*yield*/,
              this._generator.GENERATE.Tree1(
                new babylonjs_1.Vector3(100, 0, 100),
                new babylonjs_1.Vector3(0, 0, 0)
              ),
            ];
          case 1:
            // this._generator.RANDOMIZE(this._generator.GENERATE.Cylinder(new Vector3(0, 0, 0)), 100, 100)
            ...
            return [
              4 /*yield*/,
              this._generator.GENERATE.House(
                new babylonjs_1.Vector3(100, 0, 10),
                new babylonjs_1.Vector3(0, 0, 0)
              ),
            ];
          case 2:
            ...
            return [
              4 /*yield*/,
              this._generator.GENERATE.House2(
                new babylonjs_1.Vector3(100, 0, 100),
                new babylonjs_1.Vector3(0, 0, 0)
              ),
            ];
          case 3:
            ...
            return [
              4 /*yield*/,
              this._generator.GENERATE.Crate(
                new babylonjs_1.Vector3(100, 0, 100),
                new babylonjs_1.Vector3(0, 0, 0)
              ),
            ];
          case 4:
            ...
            return [
              4 /*yield*/,
              this._generator.GENERATE.Sheep(
                new babylonjs_1.Vector3(100, 0, 100),
                new babylonjs_1.Vector3(0, 0, 0)
              ),
            ];
          case 5:
            ...
            return [
              4 /*yield*/,
              this._generator.GENERATE.Fountain(
                new babylonjs_1.Vector3(50, 0, 50),
                new babylonjs_1.Vector3(0, 0, 0)
              ),
            ];
          case 6:
